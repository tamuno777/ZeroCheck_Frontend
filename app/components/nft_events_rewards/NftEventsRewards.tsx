...
export default function NftEventsRewards({ events, rewards, certifications }: NFTDashboardProps) {
            ...
            <div className="flex mb-4 gap-10">
                {tabs.map((tab) => (
                    <button
                        ...
                        className={`${activeTab === tab ? 'font-semibold' : 'font-normal'} text-black`}
                    >
                        {tab}
                    </button>
                ))}
            ...
            <div className="mt-2">
                ...
                {activeTab === 'NFT Certificatons' && (
                    <div className="space-y-6 rounded-lg bg-white p-6 shadow-lg">
                        <h2 className="text-xl font-semibold text-gray-900">NFT Certifications</h2>
